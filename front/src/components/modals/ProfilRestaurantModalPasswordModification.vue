    ...
    <div class="modal" v-if="modals.displayProfilModalPassword">
      ...
      <div class="modal__dialog">
        <div class="modal__header">
          <slot name="header">
            <h3>Modification du mot de passe - Restaurant</h3>
          </slot>
        </div>
...
export default {
  ...
  methods: {
    ...
    check_password() {
      ...
      UserServices.check_restaurant_password(this.restaurant).then((response) => {
    ...
    edit_password() {
      this.restaurant.password = this.newPassword;
      // console.log(this.restaurant);
      UserServices.edit_restaurant_password(this.restaurant).then((response) => {
