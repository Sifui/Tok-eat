...
class Offer {
    ...
    static async create (offer) {
        const result = await PostgresStore.client.query({
            text: `INSERT INTO ${Offer.tableName}
                    (name, price, description, image, id_category, id_promo)
                    VALUES ($1, $2, $3, $4, $5, $6) RETURNING *`,
                    values : [
                        offer.name, Number(offer.price), offer.description, offer.image, offer.idCategory, offer.idPromo
                    ]
        })
    ...
    static async modif(offer){
        ...
        const result = await PostgresStore.client.query({
            text: `SELECT ${Offer.tableName}.id, ${Offer.tableName}.name, ${Offer.tableName}.price, ${Offer.tableName}.description, ${Offer.tableName}.image,
            ${Category.tableName}.name as categoryName,${Category.tableName}.priority
